...
if __name__ == '__main__':
  ...
  root_file = '/eos/atlas/atlascerngroupdisk/phys-susy/RPV_mutlijets_ANA-SUSY-2019-24/ntuples/tag/input/mc16e/GG_rpv/PROD0/user.abadea.mc16_13TeV.504518.MGPy8EG_A14NNPDF23LO_GG_rpv_UDB_1400_squarks.r10724_PROD0_trees.root/user.abadea.504518.e8258_e7400_s3126_r10724_r10726_p5083.29059700._000049.trees.root'
  ...
  for version in versions:
    ...
    if run_type == 'train':
      ...
      command = f'python3 evaluate.py -l ./spanet_output/version_{version} -v {version} -i{root_file} --gpu > Log_v{version}_{run_type} 2>&1'
    else:
